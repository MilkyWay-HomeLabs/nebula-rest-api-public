...
<p style="text-align: center;">
  ...
  <img alt="Version" src="https://img.shields.io/badge/Version-5.5.0-2563eb?style=for-the-badge">
...
- 🔑 [Authentication](docs/AUTHENTICATION.md) — how client apps log in, call protected endpoints, and refresh tokens.
...
> [!IMPORTANT]
> `5.5.0` is a public preview release. The current security posture is **still not production-hardened**:
...
- `GET /api/actuator/prometheus` — public
...
3. **Build and Run**
   ...
   # Run the application
    java -jar target/nebula-rest-api-5.5.0.war
   ```

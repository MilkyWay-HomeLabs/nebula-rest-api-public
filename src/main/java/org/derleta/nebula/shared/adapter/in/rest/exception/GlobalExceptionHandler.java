...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AuthServiceUnauthorizedException.class)
    public ResponseEntity<ErrorResponse> handleAuthServiceUnauthorized(AuthServiceUnauthorizedException ex) {
        ErrorResponse errorResponse = new ErrorResponse(
                ex.getMessage(),
                "UNAUTHORIZED",
                LocalDateTime.now()
